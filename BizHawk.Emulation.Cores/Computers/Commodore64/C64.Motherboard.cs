		...
		public Motherboard(C64 c64, C64.VicType initRegion, C64.BorderType borderType, C64.SidType sidType, C64.TapeDriveType tapeDriveType, C64.DiskDriveType diskDriveType)
		{
			...
			switch (initRegion)
			{
				case C64.VicType.Ntsc:
                    ...
                    Cia0 = Chip6526.CreateKeyboardJoystickCia(C64.CiaType.Ntsc, Input_ReadKeyboard, Input_ReadJoysticks);
                    Cia1 = Chip6526.CreateIecUserPortCia(C64.CiaType.Ntsc, Cia1_ReadPortA, Cia1_ReadPortB);
                    break;
				case C64.VicType.Pal:
                    Vic = Chip6569.Create(borderType);
                    Cia0 = Chip6526.CreateKeyboardJoystickCia(C64.CiaType.Pal, Input_ReadKeyboard, Input_ReadJoysticks);
                    Cia1 = Chip6526.CreateIecUserPortCia(C64.CiaType.Pal, Cia1_ReadPortA, Cia1_ReadPortB);
                    break;
                case C64.VicType.NtscOld:
                    Vic = Chip6567R56A.Create(borderType);
                    Cia0 = Chip6526.CreateKeyboardJoystickCia(C64.CiaType.NtscRevA, Input_ReadKeyboard, Input_ReadJoysticks);
                    Cia1 = Chip6526.CreateIecUserPortCia(C64.CiaType.NtscRevA, Cia1_ReadPortA, Cia1_ReadPortB);
			        break;
                case C64.VicType.Drean:
