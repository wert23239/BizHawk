...
namespace BizHawk.Client.EmuHawk
{
    ...
    public sealed class FormsLuaLibrary : LuaLibraryBase
    {
            ...
            int? height = null)
        {
            ...
            button.Font = new Font(TextBox.DefaultFont, FontStyle.Bold);
                ...
                foreach (var form in _luaForms)
                {
                    ...
                    foreach (Control control in form.Controls)
                    {
                        if (control.Handle == ptr)
                        {
                            ...
                            {
                                return (control as LuaDropDown).SelectedItem.ToString() == "" ? "0" : (control as LuaDropDown).SelectedItem.ToString();
                            }

                            return control.Text == "" ? "0" : control.Text;
                        }
                    }
                }
            }
